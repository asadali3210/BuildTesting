/* turn.js r3 | turnjs.com/license.txt */
 (function(h) {
    ...
    g = {
        init: function(a) {
            void 0 === x && (x = "WebKitCSSMatrix" in window || "MozPerspective" in document.body.style, y = R());
            var b,
            c = this.data(),
            d = this.children(),
            a = h.extend({
        ...
        addPage: function(a, b) {
            ...
            c = !0; 
			//alert("E:"+e);
            1 <= b && b <= e && (d.done && this.turn("stop"), b in d.pageObjs && g._movePages.call(this, b, 1), c && (d.totalPages = e), d.pageObjs[b] = h(a).addClass("turn-page  bookpage  p" + b), g._addPage.call(this, b), d.done && this.turn("update"), g._removeFromDOM.call(this));
            return this
        },
        _addPage: function(a) {
            var b = this.data(),
            ...
            if (c)
                ...
                if (!b.pageWrap[a]) {
                    ...
                    e = this.height(); 
					//we have to show border on sides of pages, so increase width by 2px :)  
					d = d ; 
					//alert("width:"+d) ; 
                    c.css({
                        width: d,
        ...
        _makeFlip: function(a) {
            ...
            if (!b.pages[a] && b.pagePlace[a] == a) {
                ...
                b.pages[a] = b.pageObjs[a].css({ 
					//custom change add 2px to show border around pages  
                    width: ( c ? this.width() : this.width() / 2 ) + 2 ,
                    height: this.height()
                    }).flip({
                    page: a,
        ...
        _movePages: function(a, b) {
            ...
            f = function(a) {
                ...
                d.pagePlace[a] && d.pageWrap[a] && (d.pagePlace[c] = c, d.pageWrap[c] = d.pageWrap[a].css(K[e ? 0: f]).attr("page", c), d.pages[a] && (d.pages[c] = d.pages[a].flip("options", {
                    page: c,
                    next: e || f ? c + 1: c - 1,
        ...
        update: function() {
            ...
            if (b.pageMv.length && 0 !== b.pageMv[0]) {
                ...
                for (a in b.pageWrap)
                p(a, b.pageWrap) && (c = g._setPageLoc.call(this, a), b.pages[a] && b.pages[a].flip("disable", b.disabled || 1 != c).flip("z", null))
            },
    ...
    i = {
        ...
        _fold: function(a) {
            ...
            F = function() {
                ...
                if (d > E && (k.x += Math.abs(k.y * Math.tan(B)), k.y = 0, Math.round(k.x * Math.tan(G - d)) < u))
                ...
                H = m < r ? m / r: 1;
                if (o.opts.frontGradient && (g = 100 < v ? (v - 100) / v: 0, f = j(100 * (v * Math.sin(E - d) / u), 100 * (v * Math.cos(E - d) / r)), D && (f.y = 100 - f.y), A))
                    f.x = 100 - f.x;
